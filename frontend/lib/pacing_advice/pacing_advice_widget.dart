...
import 'pacing_advice_model.dart';
export 'pacing_advice_model.dart';

class PacingAdviceWidget extends StatefulWidget {
  const PacingAdviceWidget({super.key});

  static String routeName = 'PacingAdvice';
  static String routePath = '/pacingAdvice';

  @override
  State<PacingAdviceWidget> createState() => _PacingAdviceWidgetState();
}

class _PacingAdviceWidgetState extends State<PacingAdviceWidget> {
  late PacingAdviceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PacingAdviceModel());
